                        ...
                        <div class="header__top__right">
                            <?php
                                if(isset($_SESSION['nameUser'])) {
                                    ...
                                    echo '<a href="profile.php" class="header_user-name">Xin chào, ' . $_SESSION['nameUser'] . '</a>';
                                    echo '<button type="submit" name="logout" class="header__logout-btn">Đăng xuất</button>';
                                    echo '</form>';
                                } else {
                                ?>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="./listProduct.php">Sản phẩm</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3">
