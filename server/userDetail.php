...
<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        if ($_FILES['imageFile']['name'] !=="" ) {
            ...
            $fileDestination = "./assets/img/".$direction."/". $imgProNew;
            if (move_uploaded_file($fileTmpName, $fileDestination)) {
                $validateImg= 'Hình ảnh đã được tải lên và lưu thành công.';
                User::updateUserById($idUser,$nameUser,$phoneNumber,$address,$email,$dayOfBirth,$password,$gender,$role,$imgProNew);
            } else {
                $validateImg= '* Lỗi khi lưu hình ảnh.';
            }
        } else {
            User::updateUserById($idUser,$nameUser,$phoneNumber,$address,$email,$dayOfBirth,$password,$gender,$role,$imgUser);
        }
    }
?>
        ...
        <div class="container-fluid">
            <div class="wrapper-content">
                <h2 class="wrapper-content-heading">
                    Thông Tin <?php echo ($_GET['idRole']==2)? 'Nhân Viên' : 'Khách Hàng';?>
                </h2>
            </div>
            <form method="POST" class="wrapper-content-list-form" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="text-field">
                                    <label for="username3">
                                        Mã <?php echo ($_GET['idRole']==2)? 'Nhân Viên' : 'Khách Hàng'; ?> 
                                    </label>
                                    <input 
                                        autocomplete="off" 
                                        type="text"
                            ...
                            <div class="col-lg-6">
                                <div class="text-field">
                                    ...
                                    <input 
                                        ...
                                        type="date"
                                        name ="dayOfBirth" 
                                        value="<?php echo $user['dayOfBirth'] ?>"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="text-field">
                                    <label for="username3">Chức vụ</label>
                                    <select name="role">
                                        <?php 
                                            ...
                                            ?>
                                                <option 
                                                    value="<?php echo $row['idRole'] ?>" 
                                                    <?php 
                                                        if($user['idRole'] == $row['idRole'])
                                                        echo 'selected'; 
                                                    ?>
                                                >
                                                    <?php echo $row['nameRole'] ?>
                                                </option>
                                            <?php
                                            }
                                        ?>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="wrapper-content-list-img">
                            <div class="wrapper-content-list-img-background">
                                <img  
                                    id="previewImage" 
                                    src="./assets/img/<?php echo ($_GET['idRole']==2)? 'Employee' : 'Customer'; ?>/<?php echo $user['imgUser']; ?>" 
                                    alt="ảnh người dùng"
                                >
                ...
                <div class="row">
                    <div class="wrapper-content-btn-submit">
                        ...
                        <a href="#" class="delete-btn hidden" data-toggle="modal" data-target="#deleteItem">
                            Xóa <?php echo ($_GET['idRole']==2)? 'Nhân Viên' : 'Khách Hàng'; ?>    
                        </a>
                    </div>
                </div>
            </form>
    ...
    <div class="modal fade" id="deleteItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Bạn có muốn xóa <?php echo ($_GET['idRole']==2)? 'nhân viên' : 'khách hàng'; ?> này? </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Trờ về</button>
                    <a 
                        class="btn btn-error_log"  
                        href="./<?php echo ($_GET['idRole']==2)? 'employee' : 'customer'; ?>.php?userDel=<?php echo $_GET['idUser'];?>" >
                        Xóa <?php echo ($_GET['idRole']==2)? 'nhân viên' : 'khách hàng'; ?>
                    </a>
